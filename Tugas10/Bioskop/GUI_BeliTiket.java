...
public class GUI_BeliTiket extends javax.swing.JFrame {
    ...
    public void itempilih() {
        int row = tb_bayarTiket.getSelectedRow(); // ambil baris yang dipilih dari JTable
        if (row >= 0) {
            ...
            cmbBayar.setSelectedItem(metodeBayar);
        } else {
    ...
    String namaFilm, asalFilm, durasi, waktuTayang, metodeBayar;
    int harga, jumlah;
    ...
    public void tampil() {
        ...
        try {
            ...
            if (!adaData) {
                System.out.println("Data kosong di tb_bayar.");
            }

            tb_bayarTiket.setModel(tabelhead);
        } catch (Exception e) {
    ...
    public void insert() {
        ...
        String metodeBayar = cmbBayar.getSelectedItem().toString();

        try {
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/oop_bioskop", "root", "");
            String sql = ("INSERT INTO tb_bayar (Nama_Film, Asal_Film, Durasi, Waktu_Tayang, Harga, Jumlah, Metode_Pembayaran)"
                    + "VALUES('" + namaFilm + "','" + asalFilm + "','" + durasi + "','" + waktuTayang + "','" + harga + "','" + jumlah + "','" + metodeBayar + "')");
    ...
    public void delete() {
        ...
        if (ok == 0) {
            try {
                String sql = "DELETE FROM tb_bayar WHERE Nama_Film='" + cmbNamaFilm.getSelectedItem().toString() + "'";
    ...
    public void cari() {
        try {
            ...
            String sql = "SELECT * FROM tb_bayar WHERE Nama_Film LIKE '%" + txtSearch.getText() + "%'";
            ...
            if (rs.next()) {
                ...
                cmbBayar.setSelectedItem(rs.getString("Metode_Pembayaran"));
            } else {
    ...
    private void initComponents() {
        ...
        tb_bayarTiket = new javax.swing.JTable();
        txtSearch1 = new javax.swing.JTextField();
        btnSeacrh1 = new javax.swing.JButton();
        ...
        cmbBayar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CASH", "E-WALLET", "KARTU KREDIT", "TRANSFER BANK" }));
        ...
        tb_bayarTiket.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "Nama Film", "Asal Film", "Durasi", "Waktu Tayang", "Harga", "Jumlah", "Metode Pembayaran"
            }
        ) {
        ...
        tb_bayarTiket.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tb_bayarTiketMouseClicked(evt);
            }
        });
        jScrollPane4.setViewportView(tb_bayarTiket);

        btnSeacrh1.setText("Search");
        btnSeacrh1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSeacrh1ActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        ...
                                        .addGap(18, 18, 18)
                                        .addComponent(cmbDurasi, javax.swing.GroupLayout.PREFERRED_SIZE, 236, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addComponent(jLabel5)
                                        .addGap(18, 18, 18)
                                        .addComponent(cmbAsalFilm, javax.swing.GroupLayout.PREFERRED_SIZE, 236, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addComponent(jLabel4)
                                        .addGap(18, 18, 18)
                                        .addComponent(cmbNamaFilm, javax.swing.GroupLayout.PREFERRED_SIZE, 236, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addComponent(jLabel7)
                                        .addGap(18, 18, 18)
                                        .addComponent(cmbWaktu, javax.swing.GroupLayout.PREFERRED_SIZE, 236, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(cmbBayar, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnSeacrh1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeacrh1ActionPerformed
        // TODO add your handling code here:
        cari();
    }//GEN-LAST:event_btnSeacrh1ActionPerformed
    ...
    private void tb_bayarTiketMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb_bayarTiketMouseClicked
        // TODO add your handling code here:
        int tabel = tb_bayarTiket.getSelectedRow();
        namaFilm = tb_bayarTiket.getValueAt(tabel, 0).toString();
        asalFilm = tb_bayarTiket.getValueAt(tabel, 1).toString();
        durasi = tb_bayarTiket.getValueAt(tabel, 2).toString();
        waktuTayang = tb_bayarTiket.getValueAt(tabel, 3).toString();
        harga = Integer.parseInt(tb_bayarTiket.getValueAt(tabel, 4).toString());
        jumlah = Integer.parseInt(tb_bayarTiket.getValueAt(tabel, 5).toString());
        metodeBayar = tb_bayarTiket.getValueAt(tabel, 6).toString();
        itempilih();
    }//GEN-LAST:event_tb_bayarTiketMouseClicked
    ...
    private javax.swing.JButton btnSeacrh1;
    ...
    private javax.swing.JTable tb_bayarTiket;
