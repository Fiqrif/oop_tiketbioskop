...
public class GUI_Tiket extends javax.swing.JFrame {
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        ...
        String WktTyng = ""; // Variabel untuk waktu tayang

        // Menentukan waktu tayang berdasarkan radio button yang dipilih
        if (radiobtnSiang.isSelected()) {
            WktTyng = radiobtnSiang.getText();
        } else if (radiobtnMalam.isSelected()) {
            WktTyng = radiobtnMalam.getText();
        }
        ...
        TiketFilm tiket = new TiketFilm(namaFilm, asalFilm, durasi, WktTyng, harga);

        // Menampilkan informasi di memoTiket
        memoTiket.setText(""); // Mengosongkan memo terlebih dahulu
        memoTiket.append("Nama Film : " + tiket.nama_film +
                         "\nAsal Film : " + tiket.asal_film +
                         "\nDurasi : " + tiket.durasi +
                         "\nWaktu Tayang : " + tiket.tayang +
                         "\nHarga Tiket : RP. " + tiket.harga);

        memoTiket.setEditable(false); // Membuat hasil tidak dapat diedit
