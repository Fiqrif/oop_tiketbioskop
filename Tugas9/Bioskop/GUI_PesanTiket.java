...
public class GUI_PesanTiket extends javax.swing.JFrame {
    ...
    private void btnPesanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesanActionPerformed
        ...
        try {
            ...
            if (harga <= 0 || jumlah <= 0) {
                throw new IllegalArgumentException("Harga dan jumlah harus lebih dari 0.");
            }
            ...
            memo.append(tiket.cetak());

            memo.setEditable(false);
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Harga dan jumlah tiket harus berupa angka!", "Input Error", JOptionPane.ERROR_MESSAGE);
